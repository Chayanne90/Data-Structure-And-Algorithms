...
//        if (array.length % 2 == 0) {   // If the array size is even then the right array size is the exact same size as left
//
//            right = new int[midPoint];
//        } else {                       // If is not even then add one to the midPoint to we avoid the code to break
//            right = new int[array.length + 1];
//        }
    ...
    public int [] merge(int [ ] left, int [] right ) {
        ...
        while (leftPointer < left.length || resultPointer < right.length) {
